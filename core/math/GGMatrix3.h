#ifndef _GG_Matrix3_H_
#define _GG_Matrix3_H_

#include "GGVector3.h"

namespace Gange {
class _GGDllexport Matrix3 {
public:
    inline Matrix3() {}
    ...
    _GGDllexport friend Vector3 operator*(const Vector3 &rkVector, const Matrix3 &rkMatrix);

    /// Matrix * scalar
    Matrix3 operator*(Real fScalar) const;

    /// Scalar * matrix
    _GGDllexport friend Matrix3 operator*(Real fScalar, const Matrix3 &rkMatrix);
     ...
     */
    _GGDllexport friend std::ostream &operator<<(std::ostream &o, const Matrix3 &mat);
