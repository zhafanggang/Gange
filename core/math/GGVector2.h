#ifndef _GG_Vector2_H_
#define _GG_Vector2_H_
...
namespace Gange
{
    ...
    public:
        ...
        */
        inline Gange::Radian angleBetween( const Gange::Vector2 &other ) const
        {
            Gange::Real lenProduct = length() * other.length();
            // Divide by zero check
            if( lenProduct < 1e-6f )
                lenProduct = 1e-6f;

            Gange::Real f = dotProduct( other ) / lenProduct;

            f = Gange::Math::Clamp( f, (Gange::Real)-1.0, (Gange::Real)1.0 );
            return Gange::Math::ACos( f );
        }
        ...
        */
        inline Gange::Radian angleTo( const Gange::Vector2 &other ) const
        {
            Gange::Radian angle = angleBetween( other );

            if( crossProduct( other ) < 0 )
                angle = (Gange::Radian)Gange::Math::TWO_PI - angle;
         ...
         */
        _GGDllexport friend std::ostream &operator<<( std::ostream &o, const Vector2 &v );
    };
