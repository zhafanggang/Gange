#ifndef _GG_Quaternion_H_
#define _GG_Quaternion_H_

#include "GGPrerequisites.h"
#include "GGMath.h"

namespace Gange {
class _GGDllexport Quaternion {
public:
    ...
    */
    ...
    _GGDllexport friend Quaternion operator*(Real fScalar, const Quaternion &rkQ);
    ...
    */
    ...
    static void Intermediate(const Quaternion &rkQ0, const Quaternion &rkQ1, const Quaternion &rkQ2, Quaternion &rka,
                             Quaternion &rkB);

    /// Spherical quadratic interpolation
    static Quaternion Squad(Real fT, const Quaternion &rkP, const Quaternion &rkA, const Quaternion &rkB,
    ...
    */
    _GGDllexport friend std::ostream &operator<<(std::ostream &o, const Quaternion &q);
};
/** @} */
/** @} */
